...
function removeProperties(obj, keys) {
  ...
  const newObj = {};
  const updatedObj = Object.assign(newObj, obj);
...
const DISALLOWED_ORDERS = [
  SELECTORS_ORDER.ELEMENT,
  SELECTORS_ORDER.ID,
  SELECTORS_ORDER.PSEUDO_ELEMENT,
];
...
const cssSelectorBuilder = {
  ...
  element(value) {
    return this.part(value, SELECTORS_ORDER.ELEMENT);
  },

  id(value) {
    return this.part(`#${value}`, SELECTORS_ORDER.ID);
  },

  class(value) {
    return this.part(`.${value}`, SELECTORS_ORDER.CLASS);
  },

  attr(value) {
    return this.part(`[${value}]`, SELECTORS_ORDER.ATTRIBUTE);
  },

  pseudoClass(value) {
    return this.part(`:${value}`, SELECTORS_ORDER.PSEUDO_CLASS);
  },

  pseudoElement(value) {
    return this.part(`::${value}`, SELECTORS_ORDER.PSEUDO_ELEMENT);
  },
